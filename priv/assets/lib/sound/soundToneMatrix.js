...
function set_color(row, column, color) {
    ...
    var c = document.getElementById("tone-matrix");
...
window.initialise_matrix = function() {
...
window.bindMatrixButtons = function() {
...
window.clear_matrix = clear_matrix;
