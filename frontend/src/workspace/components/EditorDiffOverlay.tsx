      ...
      <Dialog className={classes} isOpen={true} style={this.dialogStyle}>
        <div className={`pt-dialog-body`}>
          ...
          >
            ...
            We found a more recent local backup of your program and were
            wondering if you forgot to save your work. If you do use the local
            backup's program, do remember to <strong>save</strong> your work on
            the server by clicking the "Save" button.
          </div>
